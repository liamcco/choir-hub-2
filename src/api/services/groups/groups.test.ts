...
describe('group services', () => {
  test('lists groups with effective member counts', async () => {
    ...
    expect(groups).toMatchObject([
      { id: 'root', name: 'Choir', effectiveMemberCount: 2 },
      { id: 'soprano', name: 'Soprano', effectiveMemberCount: 1 },
    ])
  })

  test('fetches group details with effective member count', async () => {
