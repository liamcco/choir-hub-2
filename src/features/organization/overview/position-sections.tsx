...
import type {
  ...
  OverviewPositionScope,
  OverviewPositionView,
...
export function PositionHistorySection({
  ...
  positionViews: OrganizationOverviewState['positionViews']
}) {
  return (
...
function PositionSection({ view }: { view: OverviewPositionView }) {
  return (
...
function PositionScopeTable({ scopes }: { scopes: OverviewPositionScope[] }) {
  return (
