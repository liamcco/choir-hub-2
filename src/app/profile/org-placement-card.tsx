...
function groupByParentId(groups: OrgGroup[]) {
  const groupsByParentId = new Map<string, OrgGroup[]>()
...
function groupPositionsByGroupId(positions: OrgPosition[]) {
  const positionsByGroupId = new Map<string, OrgPosition[]>()
